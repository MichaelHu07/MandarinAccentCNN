...
class AccentDataSet(Dataset):
    def __init__(self, stft_path, label_file, hop_length, transform = None, target_transform = None, sr = 16000, chunk_duration = 3.0):
        ...
        self.segment_length = sr * chunk_duration
    ...
    def __len__(self):
        ...
        for file in self.files:
            ...
            if self.segment_length is None or length < self.segment_length:
                ...
                total_segments += 1 + max(0, (length - self.segment_length) // self.hop_length)
    ...
    def __getitem__(self, idx):
        ...
        for file in self.files:
            ...
            if self.segment_length is None or length <= self.segment_length:
                ...
                n_segs = 1 + max(0, (length - self.segment_length) // self.hop_length)
